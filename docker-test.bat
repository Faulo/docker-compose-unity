...
set "DOCKER_OS=%~1"
set "DOCKER_TEST_PROFILE=%~2"
set "DOCKER_CONTEXT_ARGS="
set "DOCKER_TEST_OS_ARGS="
set "DOCKER_TEST_PROFILE_ARGS="
...
if not defined DOCKER_TEST_PROFILE goto profile_done
call set "DOCKER_TEST_PROFILE_ARGS=%%DOCKER_TEST_ARGS_%DOCKER_OS%_%DOCKER_TEST_PROFILE%%%"
if not defined DOCKER_TEST_PROFILE_ARGS (
    echo Missing DOCKER_TEST_ARGS_%DOCKER_OS%_%DOCKER_TEST_PROFILE% in .env
    goto test_done
)
set "DOCKER_TEST_PROFILE_ARGS=%DOCKER_TEST_PROFILE_ARGS:~1,-1%"
set "DOCKER_TEST_PROFILE_ARGS=%DOCKER_TEST_PROFILE_ARGS:\"="%"
